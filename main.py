...
class Round:
    def __init__(self, round_num: int, cash: int):
...
while True:
    start_round = int(input("Enter Start Round: ")) - 1
    ...
    print(f"You will make a total of ${cash_total} between round(s) {start_round+1} - {end_round}")
